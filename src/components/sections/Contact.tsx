                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <a
                                    key={idx}
                                    href={item.href}
                                    className="flex items-center gap-4 group p-4 rounded-2xl glass-morphism hover:bg-white/5 transition-all w-fit"
                                >
                                    <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center group-hover:text-blue-400 transition-colors">
                                        {item.icon}
                                    </div>
                                    <div>
                    ...
                    >
                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-blue-500/50 focus:outline-none transition-colors text-white placeholder:text-zinc-600"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold uppercase text-zinc-500 ml-1">Message</label>
                                <textarea
                                    rows={4}
                                    placeholder="How can I help you?"
                                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-blue-500/50 focus:outline-none transition-colors resize-none text-white placeholder:text-zinc-600"
                                />
                            </div>
